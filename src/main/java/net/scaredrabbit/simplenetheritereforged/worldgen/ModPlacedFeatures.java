package net.scaredrabbit.simplenetheritereforged.worldgen;
...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> OVERWORLD_NETHERITE_ORE_PLACED = createKey("overworld_netherite_ore_placed");
    public static final ResourceKey<PlacedFeature> END_NETHERITE_ORE_PLACED = createKey("end_netherite_ore_placed");
    public static final ResourceKey<PlacedFeature> NETHER_NETHERITE_ORE_PLACED = createKey("nether_netherite_ore_placed");
    ...
    private static ResourceKey<PlacedFeature> createKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(SimpleNetheriteReforged.MODID, name));
    }
