...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> NETHER_NETHERITE_ORE_KEY = registerKey("nether_black_opal_ore");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, NETHER_NETHERITE_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.NETHERRACK_NETHERITE_ORE.get().defaultBlockState(), 9));
    }


    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(SimpleNetheriteReforged.MODID, name));
    }
