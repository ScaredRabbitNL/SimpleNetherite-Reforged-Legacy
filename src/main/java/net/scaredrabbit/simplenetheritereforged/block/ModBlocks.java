...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> RAW_NETHERITE_BLOCK = registerBlock("raw_netherite_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).strength(3f)));

    public static final RegistryObject<Block> STONE_NETHERITE_ORE = registerBlock("stone_netherite_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).strength(3f).requiresCorrectToolForDrops(),
                    UniformInt.of(3,7)));
    public static final RegistryObject<Block> DEEPSLATE_NETHERITE_ORE = registerBlock("deepslate_netherite_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.DEEPSLATE).strength(5f).requiresCorrectToolForDrops(),
                    UniformInt.of(3, 7)));
    ...
    public static final RegistryObject<Block> NETHERRACK_NETHERITE_ORE = registerBlock("netherrack_netherite_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.NETHER_GOLD_ORE).strength(1f).requiresCorrectToolForDrops(),
                    UniformInt.of(3, 7)));
